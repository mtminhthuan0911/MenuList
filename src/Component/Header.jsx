    ...
    render() {
        return (
            <div className="header">
                <div className="LogoPage" data-toggle="modal" data-target="#modelId">
                    <div className="cartshop">
                         <p  className=""> {this.renderslcart()}</p>
                    </div>
                ...
                {/* <ul className="menu">
                    ...
                    <li className="menu-item"><a href="" className="menu-item-link" data-toggle="modal" data-target="#modelId">CartShop  </a></li>
                </ul> */}
            </div>
        )
    }
